...
@TeleOp(name="IAN Mecanum Test 2 2019", group="OpModes5291")
//@Disabled
public class MecanumBaseDrive2_2019 extends OpModeMasterLinear
{
    ...
    int[] ports = {0,1,2,3};  //have 4 sensors on front
        ...
        public void run() {
            ...
            while (true) {
                ...
                for (int i = 0; i < ports.length; i++) {
                    ...
                    bundle.putString("sensor" + i, distance[i] + "");
                }
                msg.setData(bundle);
    ...
    Handler handler1 = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            bundle = msg.getData();
            for (int i = 0; i < ports.length; i++) {
                distances[i] = Double.parseDouble(bundle.getString("sensor"+i));
            }
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        //this takes about 1 second to initialise each sensor
        ...
        while (opModeIsActive()) {
            ...
            for (int i = 0; i < ports.length; i++) {
                dashboard.displayPrintf(5 + i, "Sensor    - " + distances[i]);
            }
