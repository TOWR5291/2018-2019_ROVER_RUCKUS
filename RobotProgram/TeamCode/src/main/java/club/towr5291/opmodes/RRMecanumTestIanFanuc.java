...
public class RRMecanumTestIanFanuc extends OpModeMasterLinear
{
    ...
    private static final String TAG = "FANUC Test";
    ...
    private boolean limitswitch1, limitswitch2;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        limitswitch1 = true;//hardwareMap.get(DigitalChannel.class, "limittop");
        limitswitch2 = true;//hardwareMap.get(DigitalChannel.class, "limitbot");
        ...
        while (opModeIsActive()) {
            ...
            if ((limitswitch1 == false) && (gamepad2.right_stick_y > 0)){
            ...
            if ((limitswitch2 == false) && (gamepad2.left_stick_y > 0)){
